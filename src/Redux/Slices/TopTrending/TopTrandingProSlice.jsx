...
export const TopTrendingProSlice=createSlice({
    name:"topTrending Products",
    initialState:initialState,
    reducers:{
        addToTrending:(state,action)=>{
...
export const {addToTrending}=TopTrendingProSlice.actions;
export default TopTrendingProSlice.reducer