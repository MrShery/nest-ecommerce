...
export const RecentlyAddedProSlice=createSlice({
    name:"recentlyAdded Products",
...
export const {addToRecent}=RecentlyAddedProSlice.actions;
export default RecentlyAddedProSlice.reducer